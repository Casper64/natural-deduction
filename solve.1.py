...
==================== VERSION 1 ====================
Problems:
    - Unmanageable recursion with depending on the functions return value to decide whether a 'path' is valid
    - Unable to track steps in a proper way
    - Too many hacks to make shit work (unproper implementation)
    - Layer class lacks functionality at its current state

To take to the next version:
    - Idea/Structure of the prove function is good
    - Stack with Layers
    - Seperate Premise class
    - reject and resolve ideas
"""
